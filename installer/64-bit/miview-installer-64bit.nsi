...
; The file to write
OutFile "MIView-Setup-64bit.exe"

; The default installation directory
InstallDir $PROGRAMFILES64\MIView
...
Section "Start Menu Shortcuts"
  ...
  CreateShortCut "$SMPROGRAMS\MIView\MIView 64-bit.lnk" "$INSTDIR\MIView.exe" "" "$INSTDIR\MIView.exe" 0
