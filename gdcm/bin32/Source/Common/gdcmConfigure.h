...
#define GDCM_EXECUTABLE_OUTPUT_PATH "C:/gdcm/binaries-32/bin"
#define GDCM_LIBRARY_OUTPUT_PATH    "C:/gdcm/binaries-32/bin"
...
#define GDCM_CMAKE_INSTALL_PREFIX "C:/Program Files (x86)/GDCM 2.0"
